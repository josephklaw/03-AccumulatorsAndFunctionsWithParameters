...
#                circle.attach_to(), circle.clone(), circle.move_by()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                circle.center, circle.outline_color, circle.outline_thickness
#
...
#        necessary?  Why?
#            This method is necessary when you wish to keep the window open until the user
#            wants to close it.  It allows for the user to continue the program when he/she desires.
#
